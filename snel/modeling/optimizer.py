...
def build_optimizer(model, cfg, param_groups=None):
    ...
    """
    optim = cfg.models.optim_name
    lr = cfg.models.optim_lr
    weight_decay = cfg.models.optim_weight_decay
    momentum = cfg.models.optim_momentum
    sgd_dampening = cfg.models.optim_sgd_dampning
    sgd_nesterov = cfg.models.optim_sgd_nesterov
    rmsprop_alpha = cfg.models.optim_rmsprop_alpha
    adam_beta1 = cfg.models.optim_adam_beta1
    adam_beta2 = cfg.models.optim_adam_beta2
    staged_lr = cfg.models.optim_staged_lr
    base_lr_mult = cfg.models.optim_base_lr_mult
