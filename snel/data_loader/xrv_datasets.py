...
def xrv_normalize(img, maxval, reshape=False):
...
class PC_Dataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        sample["img"] = xrv_normalize(img, maxval=65535, reshape=True)
...
class VinBrain_Dataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        sample["img"] = xrv_normalize(img, maxval=2**float(bitdepth), reshape=True)
...
class ObjectCXR_Dataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        sample["img"] = xrv_normalize(sample["img"], maxval=255, reshape=True)
